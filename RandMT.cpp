...
void RandMT::init_by_array(uint32_t inInit_key[], int inKey_length)
{
   ...
   //std::cout<< "Init by array �a continue" << std::endl;
   i=1; j=0;
...
/*          moyenne donn�e                                              */
/*                                                                      */
/* En entr�e:   inMean La moyenne sur laquelle se base cette technique  */
/*                                                                      */
...
/*                                                                      */
/* En entr�e:   a, b Deux nombres r�els de pr�cision double             */
/*                                                                      */
/* En sortie:   Retourne un nombre pseudo-al�atoire entre 'a' et 'b' de */
/*              pr�cision double, uniform�ment r�parti                  */
/* -------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------- */
/* boxMuller    Simule une distribution Gaussienne centr�e r�duite      */
/*                                                                      */
/* En entr�e:   x1, x2  Deux pointeurs vers des r�els double pr�cision  */
/*                      qui suivront � leur sortie une loi centr�e      */
/*                      r�duite                                         */
/*                                                                      */
/* En sortie:                                                           */
/* -------------------------------------------------------------------- */
