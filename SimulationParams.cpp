...
SimulationParams::SimulationParams(char * inFilenameCity, char * inFilenameConfigParams){
         ...
         switch (_mapStringValues[paramName])
         {
             ...
             case 0:
               while ((pos = paramValues.find(delimiterValues)) != string::npos)
               {
                  ...
                  _resistanceInfectionValuesByAge.push_back(stof(value));
                  j++;
             ...
             case 1:
               ...
               {
                  value = paramValues.substr(0, pos);
                  _maxResistanceInjectionValuesByAge.push_back(stof(value));
                  j++;
                  paramValues.erase(0, pos + delimiterValues.length());
               }
               value = paramValues.substr(0, pos);
             ...
             case 2:
               ...
               {
                  value = paramValues.substr(0, pos);
                  _minResistanceInjectionValuesByAge.push_back(stof(value));
                  j++;
                  paramValues.erase(0, pos + delimiterValues.length());
               }
               value = paramValues.substr(0, pos);
             ...
             case 3:
               ...
               {
                  value = paramValues.substr(0, pos);
                  _tableTauxHospitalisationByAge.push_back(stof(value));
                  j++;
                  paramValues.erase(0, pos + delimiterValues.length());
               }
               value = paramValues.substr(0, pos);
            ...
            case 15:
               ...
               {
                  value = paramValues.substr(0, pos);
                  _histogrammeContamination.push_back(stof(value));
                  j++;
                  paramValues.erase(0, pos + delimiterValues.length());
               }
               value = paramValues.substr(0, pos);
            ...
            case 21:
               ...
               {
                  value = paramValues.substr(0, pos);
                  _tauxDeProtectionHospVaccinByAge.push_back(stof(value));
                  j++;
                  paramValues.erase(0, pos + delimiterValues.length());
               }
               value = paramValues.substr(0, pos);
            ...
            case 22:
               ...
               {
                  value = paramValues.substr(0, pos);
                  _tauxDeProtectionReaVaccinByAge.push_back(stof(value));
                  j++;
                  paramValues.erase(0, pos + delimiterValues.length());
               }
               value = paramValues.substr(0, pos);
            ...
            case 23:
               ...
               {
                  value = paramValues.substr(0, pos);
                  _tauxDeProtectionHospVaccinRappelByAge.push_back(stof(value));
                  j++;
                  paramValues.erase(0, pos + delimiterValues.length());
               }
               value = paramValues.substr(0, pos);
            ...
            case 24:
               ...
               {
                  value = paramValues.substr(0, pos);
                  _tauxDeProtectionReaVaccinRappelByAge.push_back(stof(value));
                  j++;
                  paramValues.erase(0, pos + delimiterValues.length());
               }
               value = paramValues.substr(0, pos);
            ...
            case 25:
               ...
               {
                  value = paramValues.substr(0, pos);
                  _tauxDeProtectionHospInfectionByAge.push_back(stof(value));
                  j++;
                  paramValues.erase(0, pos + delimiterValues.length());
               }
               value = paramValues.substr(0, pos);
            ...
            case 26:
               ...
               {
                  value = paramValues.substr(0, pos);
                  _tauxDeProtectionReaInfectionByAge.push_back(stof(value));
                  j++;
                  paramValues.erase(0, pos + delimiterValues.length());
               }
               value = paramValues.substr(0, pos);
            ...
            case 68:
               ...
               {
                  value = paramValues.substr(0, pos);
                  _defaultVariantHistoConta.push_back(stof(value));
                  j++;
                  paramValues.erase(0, pos + delimiterValues.length());
               }
               value = paramValues.substr(0, pos);
            ...
            case 69:
               //_variantsHistoConta = std::vector<float>(11);
               while ((pos = paramValues.find(delimiterValues)) != string::npos)
               {
                  value = paramValues.substr(0, pos);
                  _variantsHistoConta.push_back(stof(value));
                  j++;
                  paramValues.erase(0, pos + delimiterValues.length());
               }
               value = paramValues.substr(0, pos);
            ...
            case 70:
               ...
               {
                  value = paramValues.substr(0, pos);
                  _dureeVariants.push_back(stoi(value));
                  j++;
                  paramValues.erase(0, pos + delimiterValues.length());
               }
               value = paramValues.substr(0, pos);
            ...
            case 71:
               ...
               {
                  value = paramValues.substr(0, pos);
                  _pourcentAsymptomatiqueVariants.push_back(stof(value));
                  j++;
                  paramValues.erase(0, pos + delimiterValues.length());
               }
               value = paramValues.substr(0, pos);
            ...
            case 72:
               //_tableTauxHospitalisationByAgeVariants = std::vector<float>(8);
               while ((pos = paramValues.find(delimiterValues)) != string::npos)
               {
                  value = paramValues.substr(0, pos);
                  _tableTauxHospitalisationByAgeVariants.push_back(stof(value));
                  j++;
                  paramValues.erase(0, pos + delimiterValues.length());
               }
               value = paramValues.substr(0, pos);
      ...
      if(lineCity.find("#") == string::npos)
      {
         ...
         switch (_mapStringValues[paramName])
         {
            ...
            case 47:
               ...
               {
                  value = paramValues.substr(0, pos);
                  _probasCumulativesTrancheAge.push_back(stof(value));
                  j++;
                  paramValues.erase(0, pos + delimiterValues.length());
               }
               value = paramValues.substr(0, pos);
            ...
            {
               _tableTailleHopitaux = std::vector<int>();
               int test = 0;
               while (((pos = paramValues.find(delimiterValues)) != string::npos) && test < _nbHopitaux )
               {
                  test++;
                  value = paramValues.substr(0, pos);
                  _tableTailleHopitaux.push_back(stoi(value));
                  j++;
                  paramValues.erase(0, pos + delimiterValues.length());
               }
               value = paramValues.substr(0, pos);
   ...
   // Ecriture des ârametres initialisés directement dans World
   World::initWorldParams(&(*this));
   Human::initHumanParams(&(*this));
}

std::vector<float> SimulationParams::getResistanceInfectionValuesByAge()
{
   return _resistanceInfectionValuesByAge;
}

std::vector<float> SimulationParams::getMaxResistanceInjectionValuesByAge()
{
   return _maxResistanceInjectionValuesByAge;
}


std::vector<float> SimulationParams::getMinResistanceInjectionValuesByAge()
{
   return _minResistanceInjectionValuesByAge;
}


std::vector<float> SimulationParams::getTableTauxHospitalisationByAge()
{
   return _tableTauxHospitalisationByAge;
}

std::vector<int> SimulationParams::getTableTailleHopitaux()
{
...
std::vector<float> SimulationParams::getHistogrammeContamination()
{
...
std::vector<float>  SimulationParams::getTauxDeProtectionHospVaccinByAge()
{
   return _tauxDeProtectionHospVaccinByAge;
}

std::vector<float> SimulationParams::getTauxDeProtectionReaVaccinByAge()
{
   return _tauxDeProtectionReaVaccinByAge;
}

std::vector<float> SimulationParams::getTauxDeProtectionHospVaccinRappelByAge()
{
   return _tauxDeProtectionHospVaccinRappelByAge;
}

std::vector<float> SimulationParams::getTauxDeProtectionReaVaccinRappelByAge()
{
   return _tauxDeProtectionReaVaccinRappelByAge;
}

std::vector<float> SimulationParams::getTauxDeProtectionHospInfectionByAge()
{
   return _tauxDeProtectionHospInfectionByAge;
}

std::vector<float> SimulationParams::getTauxDeProtectionReaInfectionByAge()
{
...
std::vector<float>SimulationParams::getProbasCumulativesTrancheAge()
{
...
std::vector<float> SimulationParams::getDefaultVariantHistoConta()
{
   return _defaultVariantHistoConta; 
}

std::vector<float> SimulationParams::getVariantsHistoConta()
{
   return _variantsHistoConta;
}

std::vector<int> SimulationParams::getDureeVariants()
{
   return _dureeVariants;
}

std::vector<float> SimulationParams::getPourcentAsymptomatiqueVariants()
{
   return _pourcentAsymptomatiqueVariants;
}

std::vector<float> SimulationParams::getTableTauxHospitalisationByAgeVariants()
{
